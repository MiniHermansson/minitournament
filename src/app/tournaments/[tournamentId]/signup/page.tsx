...
export default function SignupPage() {
  ...
  useEffect(() => {
    if (!session) return;
    fetch(`/api/tournaments/${params.tournamentId}/signup`)
      .then((res) => res.json())
      .then((data) => {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    const res = await fetch(
      `/api/tournaments/${params.tournamentId}/signup`,
      {
        method: "POST",
  ...
  async function onWithdraw() {
    setLoading(true);
    await fetch(`/api/tournaments/${params.tournamentId}/signup`, {
      method: "DELETE",
    });
    router.push(`/tournaments/${params.tournamentId}`);
  }
